...
int main()
{
	...
	while(1){
		switch(mode){
			case 0:
				ClearLCD();
				LCD_WriteString(MY_CAST"Sample 1");
				mode = -1;
				break;
			case 1:
				ClearLCD();
				LCD_WriteString(MY_CAST"Sample 2");
				mode = -1;
				break;
			case 2:
				ClearLCD();
				LCD_WriteString(MY_CAST"Sample 3");
				mode = -1;
				break;
			case 3:
				ClearLCD();
				LCD_WriteString(MY_CAST"Sample 4");
				mode = -1;
				break;
			case 4:	
				ClearLCD();
				LCD_WriteString(MY_CAST"Sample 5");
				mode = -1;
				break;
		}
	}
